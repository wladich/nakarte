...
L.Control.TrackList = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            this.menu = new Contextmenu([
                    ...
                    {text: 'Copy link for visible tracks', callback: this.copyVisibleTracksToClipboard.bind(this)},
                {
                    ...
                    {text: 'Save all tracks to ZIP file', callback: this.saveAllTracksToZipFile.bind(this)},
                    '-',
        ...
        saveAllTracksToZipFile: async function() {
            ...
            saveAs(new Blob([zipFile], {type: 'application/download'}), 'nakarte_tracks.zip', true);
        },
